...
@Mod(modid = WTFOres.modid, name = "WhiskyTangoFox's Ores", version = "1.4", dependencies = "after:UndergroundBiomes;after:TConstructs;required-after:WTFCore@[1.6,);after:WTFTweaks")
